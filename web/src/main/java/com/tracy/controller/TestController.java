...
public class TestController {
  ...
  private void acceptMessage(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    LOG.info("Message received:servername:{} cusName:{} content:{}", servername, custermname, inputMsg.getContent());
    // 取得消息类型
    ...
    // 获取并返回多图片消息
    if (msgType.equals(Constants.IMAGE)) {
